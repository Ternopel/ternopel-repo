...
/* Bandas elasticas */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(1,1,2,'Bolsa de banditas elásticas','bolsa-bandas-elasticas',false,true,true);

INSERT INTO products_formats (product_id,format,units,wholesale,retail,quantity) VALUES 
(1,'1000 grs',10,576,65,1),
(1,'500 grs',10,300,33,1),
(1,'100 grs',10,80,10,1);

/* Bolsas economicas */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(2,5,3,'Bolsas de camisetas económicas','bolsas-camisetas-economicas',false,true,true);
...
/* Bolsas reforzadas */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(3,5,2,'Bolsas de camisetas reforzadas','bolsas-camisetas-reforzadas',false,true,false);
...
/* Bolsas consorcio */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(4,5,5,'Bolsas de consorcio','bolsas-consorcio',false,true,false);
...
/* Bolsas residuos */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(5,5,2,'Bolsas de residuos','bolsas-residuos',false,true,false);
...
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(6,5,2,'Bolsas de papel sulfito','bolsas-papel-sulfito',false,true,false);
...
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(7,5,2,'Bolsas de polipropileno','bolsas-polipropileno',false,true,false);
...
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(8,2,3,'Productos de Aluminio','productos-aluminio',false,true,false);
...
/* Caja de madera */
INSERT INTO products (id,category_id,packaging_id,name,url,show_format,is_visible,is_offer) VALUES 
(9,7,1,'Caja de madera','caja-madera',false,true,true);
