			...
			function(content,categories, callback) {
				...
				jsreport.render({
					template: {
						...
						engine: "jsrender",
						phantom: {
							header: "<h2 style='background-color: lightGray; font-size: 17px;'>Listado de Productos por Categor&iacute;a &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ternopel - email: info@ternopel.com - whatsapp: 15-5888-3335</h2>",
